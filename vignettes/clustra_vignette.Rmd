...
datlist_f=curvefun(param_l)
  ...
  for(n in 1:numit){
    ...
    data[[n]]$outv1_std = scale(data[[n]]$outv1[,1])
    data[[n]]$outv2_std = scale(data[[n]]$outv2[,1])
    }
...
WriteXLS(df, ExcelFileName = paste0(param_l[[scen]][[1]],"_runstart_",seedst,"_nrun",numit,".xlsx"))
```
