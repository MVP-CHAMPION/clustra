...
cl = clustra(data, k = 3, fp = list(maxdf = 30, iter = 10),
                   cores = c(e_mc = 4, m_mc = 4, nthreads = 1, blas = 1), verbose = TRUE)
```
...
cl = clustra(data2, k = 3, fp = list(maxdf = 30,
                   cores = c(e_mc = 4, m_mc = 4, nthreads = 1, blas = 1),
...
```{r fig.width = 7}
set.seed(1234737)
sil = clustra_sil(data, k = c(2, 3, 4), cores = c(e_mc = 4, m_mc = 4, nthreads = 1, blas = 1),
                  verbose = TRUE)
plot_sil = function(x) {
