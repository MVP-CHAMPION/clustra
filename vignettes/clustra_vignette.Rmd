...
clus1<-defDataAdd(varname="sys",formula="0.0375*time+85",variance=2)
clus1<-defDataAdd(clus1,varname="dia",formula="95",variance=2)

clus2<-defDataAdd(varname="sys",formula="65",variance=2)
clus2<-defDataAdd(clus2,varname="dia",formula="0.05*time+65",variance=2)

clus3<-defDataAdd(varname="sys",formula="-0.0375*time+45",variance=2)
clus3<-defDataAdd(clus3,varname="dia",formula="35",variance=2)
...
data[[q]] = gen_traj_data(vars, clusters = c(800, 1000,1200), m_obs = 10, 
                     curvlist=curvlist[[q]], 
                     s_range = c(-365, -90), e_range = c(0.5*365, 365),
