...
clus8<-defDataAdd(clus8,varname="dia",formula="-100+sin(-100+3.14159*time/400)*10",variance=2)
...
data[[q]] = gen_traj_data(vars, clusters = c(800, 1000,1200), m_obs = 10, 
                     curvlist=curvlist[[q]], cvlist=cvlist[[q]],
...
```{r}
cl = rep(list(NULL),length(meanlist))
 for(s in 1:length(meanlist)){
   set.seed(rs[[s]])
