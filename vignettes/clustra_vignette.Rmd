...
clus6<-defDataAdd(clus6,varname="dia",formula="20",variance=2)

clus7<-defDataAdd(varname="sys",formula="65",variance=2)
clus7<-defDataAdd(clus7,varname="dia",formula="80+sin(-100+3.14159*time/300)*10",variance=2)

clus8<-defDataAdd(varname="sys",formula="0.0375*time+85",variance=2)
clus8<-defDataAdd(clus8,varname="dia",formula="40+sin(-100+3.14159*time/400)*10",variance=2)


curv1=c(1,2,3) 
curv2=c(4,7,8)  
 
 curvlist=list(curv1, curv2)
